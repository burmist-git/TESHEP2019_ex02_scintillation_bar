...
void SteppingAction::UserSteppingAction(const G4Step* aStep)
{
  ...
  if ((aPrePV->GetName().contains("barCoating_base") ||
       aPrePV->GetName().contains("barCoating_side_r") ||
       aPrePV->GetName().contains("barCoating_side_l") ) &&
      aPostPV->GetName().contains("scintillatorHole") && trackID == 1) {  
